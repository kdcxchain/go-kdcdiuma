Name "gkdc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/kdcxchain/go-kdcdiuma/issues"
!define UPDATEURL "https://github.com/kdcxchain/go-kdcdiuma/releases"
!define ABOUTURL "https://github.com/kdcxchain/go-kdcdiuma#ethereum-go"
...
# Install gkdc binary
Section "Gkdc" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gkdc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gkdc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gkdc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gkdc incoming peers (TCP:33960)"
  SimpleFC::AdvRemoveRule "Gkdc outgoing peers (TCP:33960)"
  SimpleFC::AdvRemoveRule "Gkdc UDP discovery (UDP:33960)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gkdc incoming peers (TCP:33960)" ""  6 1 1 2147483647 1 "$INSTDIR\gkdc.exe" "" "" "Ethereum" 33960 "" "" ""
  SimpleFC::AdvAddRule "Gkdc outgoing peers (TCP:33960)" ""  6 2 1 2147483647 1 "$INSTDIR\gkdc.exe" "" "" "Ethereum" "" 33960 "" ""
  SimpleFC::AdvAddRule "Gkdc UDP discovery (UDP:33960)" "" 17 2 1 2147483647 1 "$INSTDIR\gkdc.exe" "" "" "Ethereum" "" 33960 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gkdc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gkdc.ipc"

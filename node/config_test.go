...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gkdc.ipc", false, filepath.Join(os.TempDir(), "gkdc.ipc")},
		{"data", "gkdc.ipc", false, "data/gkdc.ipc"},
		{"data", "./gkdc.ipc", false, "./gkdc.ipc"},
		{"data", "/gkdc.ipc", false, "/gkdc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gkdc.ipc", true, `\\.\pipe\gkdc.ipc`},
		{"data", "gkdc.ipc", true, `\\.\pipe\gkdc.ipc`},
		{"data", `\\.\pipe\gkdc.ipc`, true, `\\.\pipe\gkdc.ipc`},
	}
